  ...
  return (
    <div className="info-section" id="services">
      <div className="info-title-content">
        ...
        We make healthcare convenient for you by offering a wide range of on-demand medical services tailored to your needs. 
        Through our platform, you can connect with experienced online doctors 
        for expert medical advice, receive online prescriptions, and access quick refills whenever necessary.
        </p>
      </div>
