    ...
    <div className="ba-section">
      ...
      <div className="ba-text-content">
        <h3 className="ba-title">
          <span>Why Choose Hospify</span>
        </h3>
        <p className="ba-description">
        Discover why Hospify is the best choice for your healthcare needs. 
        Enjoy expert care, convenience, and personalized solutions, 
        all with your well-being as our top priority.
        Embark on a journey with us towards better health and a happier life.
        </p>
